// traingame.js
import { countdownSolve } from "/traingame/bundle/solver_x2.js";

// ---------- DOM references ----------
const slots = document.querySelectorAll('.numbin.countdownGame');
...
// ---------- Loader ----------
document.addEventListener('DOMContentLoaded', initCountdownGame);
